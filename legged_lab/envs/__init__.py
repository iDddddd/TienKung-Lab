...
from legged_lab.envs.F1.f1_env import F1Env
from legged_lab.envs.F1.walk_cfg import F1WalkAgentCfg, F1WalkFlatEnvCfg
...
task_registry.register("f1_walk", F1Env, F1WalkFlatEnvCfg(), F1WalkAgentCfg())
